...
当前发布版本：[v0.3.4](https://github.com/Waylon524/tree/releases/tag/v0.3.4)

| 平台 | 安装包 | 说明 |
| --- | --- | --- |
| macOS Apple Silicon | [TREE_0.3.4_macos.dmg](https://github.com/Waylon524/tree/releases/download/v0.3.4/TREE_0.3.4_macos.dmg) | 已使用 Developer ID 签名、公证并 stapled。 |
| Windows x64 | [TREE_0.3.4_x64-setup.exe](https://github.com/Waylon524/tree/releases/download/v0.3.4/TREE_0.3.4_x64-setup.exe) | NSIS 安装包。Windows 可能因新应用信誉不足显示 SmartScreen 提醒。 |
| Windows x64 | [TREE_0.3.4_x64_en-US.msi](https://github.com/Waylon524/tree/releases/download/v0.3.4/TREE_0.3.4_x64_en-US.msi) | MSI 安装包，适合偏好 Windows Installer 的场景。 |

SHA-256：

```text
TREE_0.3.4_macos.dmg          aa310710cdd4844519bd9ce4f40cb06dcb579b92956b6c156cf8221d4fe82068
TREE_0.3.4_x64-setup.exe      33255e60a1c560b6fe6e1073d49d77e66e366b82d91b6a2e3b3cbe013b0f62ca
TREE_0.3.4_x64_en-US.msi      aa18a91ef3f219745a9f547c86a8c52aa891face5a2631deb8fdb8e20a381115
```
...
普通用户通常只需要配置一次 LLM 和 PaddleOCR。全局配置保存在 `~/.tree/config.env`。
